...
class ExMenubutton(ttk.Menubutton, _WidgetMixin):
    """Extended menu button widget."""

    def __init__(self, master: _Widget=None, *, menu: tk.Menu | None=None, **kw) -> None:
        super().__init__(master, **kw)
        self.menu = menu

    @property
    def menu(self) -> tk.Menu | None:
        """The associated menu."""
        return self._menu

    @menu.setter
    def menu(self, menu: tk.Menu | None) -> None:
        self._menu = menu
        self.configure(menu=menu) # pyright: ignore
